const TUNING_DEFAULTS = {
  ...
  soundGunshotRadius: 600,
  soundProjectileImpactRadius: 420,
  soundWindowImpactRadius: 500,
  soundMetalDoorImpactRadius: 480,
  soundGeometryDestructionRadius: 560,
  soundFootstepRadius: 120,
  soundBodyFallRadius: 140,
  ...
  muzzleFlashRadius: 420,
  muzzleFlashIntensity: 1,
  muzzleFlashFalloffPower: 1,
  muzzleFlashLifetimeFrames: 4,
  ...
  playerProjectilePenetrationPower: 1,
  playerRadius: 28,
  ...
  enemySuspicionConfirmDelay: 10,
  enemyDamagedDoorConfirmDelay: 90,
  enemyCautiousFrames: 1800,
  enemyEventMemoryFrames: 900,
  enemyShotMemoryFrames: 300,
  enemyImpactConfirmationFrames: 180,
  enemySuspicionTeamSize: 4,
  enemyRadius: 16,
  enemyHitRadius: 20,
  ...
  doorMaxHp: 2000,
  doorDamage: 20,
  doorProjectileResistance: 0.5,
  windowMaxHp: 60,
  windowDamage: 20,
  windowProjectileResistance: 0.15,
  doorSwingFrames: 12,
  metalDoorSwingFrames: 24,
  unarmoredBodyPenetrationResistance: 1,
...
const TUNING_SECTIONS = [
  {
    ...
    controls: [
      ...
      { key: 'debugHiddenEnemies', label: 'Hidden enemy silhouettes', type: 'toggle', debugChild: true },
  ...
  },
  {
    ...
    controls: [
      ...
      { key: 'soundProjectileImpactRadius', label: 'Projectile impact radius', min: 40, max: 600, step: 10, unit: 'u' },
      { key: 'soundWindowImpactRadius', label: 'Window impact radius', min: 40, max: 600, step: 5, unit: 'u' },
      { key: 'soundMetalDoorImpactRadius', label: 'Metal-door impact radius', min: 40, max: 600, step: 10, unit: 'u' },
      { key: 'soundGeometryDestructionRadius', label: 'Door/window break radius', min: 40, max: 600, step: 10, unit: 'u' },
      { key: 'soundFootstepRadius', label: 'Footstep radius', min: 20, max: 360, step: 5, unit: 'u' },
      { key: 'soundBodyFallRadius', label: 'Body-fall radius', min: 20, max: 360, step: 5, unit: 'u' },
  ...
  },
  {
    ...
    controls: [
      ...
      { key: 'muzzleFlashRadius', label: 'Muzzle flash radius', min: 40, max: 1200, step: 10, unit: 'u' },
      { key: 'muzzleFlashIntensity', label: 'Muzzle flash intensity', min: 0, max: 2, step: 0.01, decimals: 2 },
      { key: 'muzzleFlashFalloffPower', label: 'Muzzle flash falloff', min: 0.2, max: 4, step: 0.05, decimals: 2 },
      { key: 'muzzleFlashLifetimeFrames', label: 'Muzzle flash lifetime', min: 1, max: 20, step: 1, unit: 'f' },
    ],
  },
  {
    title: 'Player',
    controls: [
      ...
      { key: 'playerProjectilePenetrationPower', label: 'Bullet penetration', min: 0, max: 6, step: 0.25, decimals: 2 },
  ...
  },
  {
    ...
    controls: [
      ...
      { key: 'enemySuspicionConfirmDelay', label: 'Suspicious confirm delay', min: 0, max: 240, step: 1, unit: 'f' },
      { key: 'enemyDamagedDoorConfirmDelay', label: 'Door inspection delay', min: 0, max: 240, step: 1, unit: 'f' },
      { key: 'enemyCautiousFrames', label: 'Cautious duration', min: 0, max: 3600, step: 30, unit: 'f' },
      { key: 'enemyEventMemoryFrames', label: 'Event memory', min: 60, max: 3600, step: 30, unit: 'f' },
      { key: 'enemyShotMemoryFrames', label: 'Shot memory', min: 30, max: 1200, step: 30, unit: 'f' },
      { key: 'enemyImpactConfirmationFrames', label: 'Impact confirmation window', min: 30, max: 600, step: 10, unit: 'f' },
      { key: 'enemySuspicionTeamSize', label: 'Suspicion team size', min: 1, max: 8, step: 1 },
      ...
      { key: 'enemySuspiciousSpeed', label: 'Suspicious speed', min: 0.1, max: 6, step: 0.05, decimals: 2 },
      { key: 'enemyAlertSpeed', label: 'Alert speed', min: 0.1, max: 6, step: 0.05, decimals: 2 },
      ...
      { key: 'enemyProjectilePenetrationPower', label: 'Bullet penetration', min: 0, max: 6, step: 0.25, decimals: 2 },
  ...
  },
  {
    ...
    controls: [
      { key: 'doorMaxHp', label: 'Door max HP', min: 20, max: 5000, step: 20, unit: 'hp' },
      { key: 'doorDamage', label: 'Door damage per shot', min: 1, max: 120, step: 1, unit: 'dmg' },
      { key: 'doorProjectileResistance', label: 'Door penetration resistance', min: 0, max: 4, step: 0.25, decimals: 2 },
      { key: 'windowMaxHp', label: 'Window max HP', min: 1, max: 300, step: 1, unit: 'hp' },
      { key: 'windowDamage', label: 'Window damage per shot', min: 1, max: 120, step: 1, unit: 'dmg' },
      { key: 'windowProjectileResistance', label: 'Window penetration resistance', min: 0, max: 4, step: 0.05, decimals: 2 },
      { key: 'doorSwingFrames', label: 'Door swing duration', min: 1, max: 45, step: 1, unit: 'f' },
      { key: 'metalDoorSwingFrames', label: 'Metal-door swing duration', min: 1, max: 90, step: 1, unit: 'f' },
      { key: 'unarmoredBodyPenetrationResistance', label: 'Body penetration resistance', min: 0, max: 4, step: 0.25, decimals: 2 },
