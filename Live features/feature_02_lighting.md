...
- Twelve wall lamps provide warm radial light and can be shot off. Lamp hits use the shared swept projectile query, so fast bullets cannot skip a fixture or lose the hit to its supporting wall.
